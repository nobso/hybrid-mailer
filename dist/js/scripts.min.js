...
!(function(e, t) {
    ...
    var n = [],
        ...
        c = u.hasOwnProperty,
        f = {},
        p = '2.2.5-pre b14ce54334a568eaaa107be4c441660a57c3db24',
        d = function(e, t) {
                    ...
                    for (t in e)
                        (n = s[t]),
                            s !== (r = e[t]) &&
                                (l &&
                                r &&
                                (d.isPlainObject(r) || (i = d.isArray(r)))
                                    ? (i
                                          ? ((i = !1),
                                            (o = n && d.isArray(n) ? n : []))
                                          : (o =
            ...
            globalEval: function(e) {
                ...
                (e = d.trim(e)) &&
                    (1 === e.indexOf('use strict')
                        ? (((t = r.createElement('script')).text = e),
                          r.head.appendChild(t).parentNode.removeChild(t))
                        : n(e));
            },
    ...
    var x = (function(e) {
            ...
            return s !== d && 9 === s.nodeType && s.documentElement
                ? ((h = (d = s).documentElement),
                  ...
                  (i = d.defaultView) &&
                      i.top !== i &&
                      (i.addEventListener
                          ? i.addEventListener('unload', ne, !1)
                          : i.attachEvent && i.attachEvent('onunload', ne)),
            ...
            return (
                ...
                oe(function(o, s, a, u) {
                    var l,
                        ...
                        m = n ? (i || (o ? e : h || r) ? [] : s) : v;
                    if ((n && n(v, m, a, u), r))
                        for (l = me(m, d), r(l, [], a, u), c = l.length; c--; )
                            (f = l[c]) && (m[d[c]] = !(v[d[c]] = f));
                    if (o) {
                        if (i || e) {
                            if (i) {
        ...
        return (
            (de.prototype = r.filters = r.pseudos),
            (r.setFilters = new de()),
                    ...
                    for (
                        ...
                        if (
                            ...
                            (o = p(
                                ...
                                (K.test(l[0].type) && pe(t.parentNode)) || t,
                            ))
                        ) {
    ...
    (d.filter = function(e, t, n) {
        ...
        d.fn.extend({
            ...
            is: function(e) {
                return !!E(
                    this,
                    'string' == typeof e && T.test(e) ? d(e) : e || [],
                    !1,
                ).length;
            },
        });
            ...
            function(e, t) {
                d.fn[e] = function(n, r) {
                    ...
                    return (
                        ...
                        this.length > 1 &&
                            (D[e] || d.uniqueSort(i), j.test(e) && i.reverse()),
                        this.pushStack(i)
                    );
                };
            },
                        ...
                        d.isArray(t)
                            ...
                            : ((i = d.camelCase(t)),
                              t in o
                                  ? (r = [t, i])
                                  : (r =
                                        (r = i) in o ? [r] : r.match(L) || [])),
                            (n = r.length);
                        for (; n--; ) delete o[r[n]];
                    }
                    (void 0 === t || d.isEmptyObject(o)) &&
                        (e.nodeType
    ...
    function ee(e, t, n, r, i) {
        ...
        for (f.textContent = '', h = 0; (o = p[h++]); )
            if (r && d.inArray(o, r) > -1) i && i.push(o);
                ...
                ((l = d.contains(o.ownerDocument, o)),
                            ...
                            (c = d.extend(
                                {
                                    ...
                                    selector: i,
                                    needsContext:
                                        i && d.expr.match.needsContext.test(i),
                                    namespace: g.join('.'),
                                },
                                o,
                            )),
                ...
                for (l = (t = (t || '').match(L) || ['']).length; l--; )
                    if (
                        ...
                        s &&
                            !p.length &&
                            ((f.teardown &&
                                !1 !== f.teardown.call(e, g, m.handle)) ||
    ...
    function ve(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            M.hasData(e) &&
                ((a = M.access(e)), (u = d.extend({}, a)), M.set(t, u));
        }
    }
    function me(e, t) {
        var n = t.nodeName.toLowerCase();
    ...
    function ye(e, t, n, r) {
        ...
        var i,
            ...
            v = t[0],
            m = d.isFunction(v);
        if (m || (h > 1 && 'string' == typeof v && !f.checkClone && ce.test(v)))
        ...
        if (
            h &&
            ((s = (i = ee(t, e[0].ownerDocument, !1, e, r)).firstChild),
            1 === i.childNodes.length && (i = s),
            s || r)
        ) {
            for (u = (a = d.map(J(i, 'script'), he)).length; p < h; p++)
                (l = i),
                    p !== g &&
                        ((l = d.clone(l, !0, !0)),
                        u && d.merge(a, J(l, 'script'))),
                    n.call(e[p], l, p);
            if (u)
                for (
                    c = a[a.length - 1].ownerDocument, d.map(a, ge), p = 0;
                    p < u;
                    p++
                )
                    (l = a[p]),
                        G.test(l.type || '') &&
                            ...
                            (l.src
                                ...
                                : d.globalEval(l.textContent.replace(pe, '')));
        }
        return e;
    }
    function xe(e, t, n) {
        for (var r, i = t ? d.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            n || 1 !== r.nodeType || d.cleanData(J(r)),
                r.parentNode &&
                    (n && d.contains(r.ownerDocument, r) && K(J(r, 'script')),
    ...
    d.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (
                ...
                for (s = J(a), r = 0, i = (o = J(e)).length; r < i; r++)
                    me(o[r], s[r]);
            if (t)
                if (n)
                    for (
                        o = o || J(e), s = s || J(a), r = 0, i = o.length;
                        r < i;
                        r++
                    )
                        ve(o[r], s[r]);
            ...
            return (
                (s = J(a, 'script')).length > 0 && K(s, !u && J(e, 'script')), a
            );
        },
        ...
        d.fn.extend({
            ...
            empty: function() {
                for (var e, t = 0; null != (e = this[t]); t++)
                    1 === e.nodeType &&
                        (d.cleanData(J(e, !1)), (e.textContent = ''));
                return this;
            },
            clone: function(e, t) {
                return (
        ...
        d.each(
            ...
            function(e, t) {
                d.fn[e] = function(e) {
                    for (
                        var n, r = [], i = d(e), o = i.length - 1, a = 0;
                        a <= o;
                        a++
                    )
    ...
    function Me(e, t, n, r, i) {
        for (
            ...
            'margin' === n && (s += d.css(e, n + X[o], !0, i)),
                r
                    ? ('content' === n &&
                          (s -= d.css(e, 'padding' + X[o], !0, i)),
                      'margin' !== n &&
                          (s -= d.css(e, 'border' + X[o] + 'Width', !0, i)))
                    : ((s += d.css(e, 'padding' + X[o], !0, i)),
                      'padding' !== n &&
                          (s += d.css(e, 'border' + X[o] + 'Width', !0, i)));
        return s;
    ...
    function Ie(e, t, n) {
        ...
        if (i <= 0 || null == i) {
            if (
                (((i = De(e, t, o)) < 0 || null == i) && (i = e.style[t]),
                Ee.test(i))
            )
                return i;
            ...
            (r = e[s]).style &&
                ...
                t
                    ? (o[s] || 'none' !== n || (r.style.display = ''),
                      '' === r.style.display &&
                          z(r) &&
                          (o[s] = R.access(r, 'olddisplay', Ce(r.nodeName))))
                    : ((i = z(r)),
                      ('none' === n && i) ||
                          R.set(r, 'olddisplay', i ? n : d.css(r, 'display'))));
        for (s = 0; s < a; s++)
            (r = e[s]).style &&
    ...
    d.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i,
                    ...
                    u = e.style;
                return (
                    (t = d.cssProps[a] || (d.cssProps[a] = Pe(a) || a)),
        ...
        d.each(['height', 'width'], function(e, t) {
            d.cssHooks[t] = {
                get: function(e, n, r) {
                    if (n)
                        return qe.test(d.css(e, 'display')) &&
                            0 === e.offsetWidth
                            ? Se(e, Le, function() {
                                  return Ie(e, t, r);
                              })
                    ...
                    var i,
                        ...
                        s =
                            ...
                            Me(
                                ...
                                t,
                                r,
                                'border-box' === d.css(e, 'boxSizing', !1, o),
                                o,
                            );
                    return (
                        s &&
        ...
        (d.cssHooks.marginLeft = Ae(f.reliableMarginLeft, function(e, t) {
            if (t)
                return (
        ...
        (d.cssHooks.marginRight = Ae(f.reliableMarginRight, function(e, t) {
            if (t)
                return Se(e, { display: 'inline-block' }, De, [
                    e,
                    'marginRight',
                ]);
        })),
        d.each({ margin: '', padding: '', border: 'Width' }, function(e, t) {
            (d.cssHooks[e + t] = {
                ...
                ke.test(e) || (d.cssHooks[e + t].set = Re);
        }),
        d.fn.extend({
            css: function(e, t) {
                return O(
    ...
    function Ye(e, t, n) {
        for (
            var r,
                i = (Ge.tweeners[t] || []).concat(Ge.tweeners['*']),
                o = 0,
                s = i.length;
            o < s;
            o++
    ...
    function Ge(e, t, n) {
        ...
        for (
            ...
            if ((r = Ge.prefilters[o].call(l, e, c, l.opts)))
                return (
                    d.isFunction(r.stop) &&
                        (d._queueHooks(l.elem, l.opts.queue).stop = d.proxy(
                            r.stop,
                            r,
                        )),
                    r
    ...
    (d.Animation = d.extend(Ge, {
                ...
                1 === e.nodeType &&
                    ...
                    'inline' ===
                        ('none' === (l = d.css(e, 'display'))
                            ? R.get(e, 'olddisplay') || Ce(e.nodeName)
                            : l) &&
                        'none' === d.css(e, 'float') &&
        ...
        (d.fx.interval = 13),
        (d.fx.start = function() {
            _e || (_e = e.setInterval(d.fx.tick, d.fx.interval));
        }),
        (d.fx.stop = function() {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ...
                        : ((1 === o && d.isXMLDoc(e)) ||
                              ...
                              (i =
                                  d.attrHooks[t] ||
                                  (d.expr.match.bool.test(t) ? Qe : void 0))),
                          void 0 !== n
                              ? null === n
            ...
            if (
                ...
                for (s = 0; (a = g[s++]) && !t.isPropagationStopped(); )
                    (t.type = s > 1 ? l : h.bindType || v),
                        (p =
                            (R.get(a, 'events') || {})[t.type] &&
                            R.get(a, 'handle')) && p.apply(a, n),
                        (p = f && a[f]) &&
                            p.apply &&
                            F(a) &&
    ...
    (vt.href = ot.href),
        d.extend({
            ...
            ajax: function(t, n) {
                ...
                if (
                    ((v.promise(C).complete = m.add),
                    (C.success = C.done),
                    (C.error = C.fail),
                    (p.url = ((t || p.url || ot.href) + '')
                        .replace(ut, '')
                        .replace(pt, ot.protocol + '//')),
    ...
    var Nt = { 0: 200, 1223: 204 },
        St = d.ajaxSettings.xhr();
    (f.cors = !!St && 'withCredentials' in St),
        (f.ajax = St = !!St),
        d.ajaxTransport(function(t) {
            var n, r;
            if (f.cors || (St && !t.crossDomain))
                return {
                    send: function(i, o) {
                        var s,
                            a = t.xhr();
    ...
    (d.fn.load = function(e, t, n) {
        ...
        var r,
            ...
            a = e.indexOf(' ');
        return (
            a > -1 && ((r = d.trim(e.slice(a))), (e = e.slice(0, a))),
            d.isFunction(t)
                ? ((n = t), (t = void 0))
        ...
        d.each(['top', 'left'], function(e, t) {
            d.cssHooks[t] = Ae(f.pixelPosition, function(e, n) {
                if (n)
                    return (
                        (n = De(e, t)),
                        Ee.test(n) ? d(e).position()[t] + 'px' : n
                    );
            });
        }),
...
$(function() {
    $(document).ready(function() {
        let e = !0,
            n = document.querySelector('.overlay-content').innerHTML;
        function t(n) {
            n.preventDefault(),
        ...
        function o(t) {
            document.querySelector('.overlay-content').innerHTML = t
                ? `<span class='${e ? 'success' : 'fail'}'>${t}</span>`
                : n;
        }
            ...
            $('form').submit(function(n) {
                ...
                (document.querySelector('.overlay').style.display = 'block'),
                    $.ajax({
                        ...
                        data: t,
                        success: function() {
                            (e = !0), o('The mail is successfully sent.');
                        },
                        error: function(n) {
                            var t;
                            n.responseJSON &&
                                ...
                                (e = !1),
                                o('Failed, the mail is not sent. Try again.');
                        },
                    });
            });
    });
